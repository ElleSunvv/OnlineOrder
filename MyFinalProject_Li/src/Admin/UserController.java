...
public class UserController {
	...
	@FXML 
	public  void addUserAc(ActionEvent event) throws Exception {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Admin/AddUserView.fxml"));
	...
	@FXML 
	public void userList(ActionEvent event) throws Exception {
		try {
	        Parent root = FXMLLoader.load(getClass().getResource("/Admin/UserListView.fxml"));
	...
	public  void backtoAdminPage(ActionEvent event) throws Exception {
	    try {
	        Parent root = FXMLLoader.load(getClass().getResource("/Admin/UserControlView.fxml"));
	        Scene create = new Scene(root);
	        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
	        window.setScene(create);
	        window.show();
